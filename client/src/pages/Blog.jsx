      ...
      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <form onSubmit={addComment} className="flex flex-col items-start gap-4 max-w-lg">
            <input onChange={(e)=> setName(e.target.value)} value={name} type="text" placeholder="Name" className="w-full p-2 border-gray-300 rounded outline-none" />
       ...
       <div className="my-24 max-w-3xl mx-auto">
        <p className="font-semibold my-4">Share title article on social media</p>
        <div className="flex">
